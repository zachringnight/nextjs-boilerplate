/**
 * Clip marker constants for ASW (adapted from Prizm for basketball/ASW stations)
 */
...
> = {
  ...
  tunnel_walk: { label: 'Tunnel Walk', icon: PersonStanding, color: '#22C55E', shortcut: 'T' },
  product_shoot: { label: 'Product', icon: Camera, color: '#EF4444', shortcut: 'P' },
