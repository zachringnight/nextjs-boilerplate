...
export const players: Player[] = [
  ...
  // =====================
  {
    ...
    questions: {
      signing: [
        { type: 'checklist', text: 'Intro (no specifics needed).' },
        {
          type: 'question',
          text: 'These are soon-to-be-released cards. What do you want collectors to feel when they get your autograph on this release?'
        },
        { type: 'question', text: 'What is the defining moment from this season you would want captured on a card forever?' },
        { type: 'question', text: 'Your game is explosion plus control. What is the skill you are most proud of sharpening this year?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ],
      packRip: [
        { type: 'checklist', text: 'Intro (no specifics needed).' },
        { type: 'question', text: 'Who are you hoping to pull right now?' },
        { type: 'question', text: 'Favorite card memory growing up?' },
        { type: 'question', text: 'Favorite card design you have seen lately?' },
        { type: 'question', text: 'If you could design a speed-and-playmaking insert, what is the name and vibe?' },
        { type: 'question', text: 'What makes you a true 1/1?' },
        { type: 'question', text: 'What moment from this season deserves to live on a card forever?' },
        { type: 'question', text: 'When you think Detroit football right now, what is the identity you love about this team?' },
        { type: 'question', text: 'If a kid pulls your card today, what do you hope they feel?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ]
    }
  },
  {
    ...
    questions: {
      signing: [
        ...
        {
          type: 'question',
          text: 'For an offensive lineman, what does a true ‘card moment’ look like? What play would you put on cardboard forever?'
        },
        { type: 'question', text: 'What is the mindset you bring to every snap that you want fans to associate with your name?' },
        { type: 'question', text: 'What do you love about collectors appreciating the work in the trenches?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ]
    }
  },
  {
    ...
    questions: {
      signing: [
        { type: 'checklist', text: 'Intro (no specifics needed).' },
        { type: 'question', text: 'What play from this season best shows ‘Kyle Hamilton football’ and belongs on a card forever?' },
        { type: 'question', text: 'You can do everything on defense. What role do you enjoy most and why?' },
        { type: 'question', text: 'What does it mean when fans collect defenders and celebrate the details of the job?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ]
    }
  },
  {
    ...
    questions: {
      packRip: [
        ...
        { type: 'question', text: 'Who are you hoping to pull right now?' },
        { type: 'question', text: 'Favorite card memory growing up?' },
        { type: 'question', text: 'Favorite card design you have seen, and why it stood out?' },
        { type: 'question', text: 'If you could create a QB-focused insert, what is the name and concept?' },
        { type: 'question', text: 'What makes you a true 1/1?' },
        { type: 'question', text: 'What moment from your football journey deserves to live on a card forever?' },
        { type: 'question', text: 'What does being part of the Panini family mean to you as you build the next chapter?' },
        { type: 'question', text: 'If a kid pulls your card today, what do you hope they feel?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ]
    }
  },
  {
    ...
    questions: {
      signing: [
        ...
        { type: 'question', text: 'Tight end is the ultimate utility role. What part of the job do you take the most pride in?' },
        { type: 'question', text: 'What is the moment from this season you would want captured on a card forever?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ]
    }
  },
  {
    ...
    questions: {
      packRip: [
        { type: 'checklist', text: 'Intro (no specifics needed).' },
        { type: 'question', text: 'Who are you hoping to pull right now?' },
        { type: 'question', text: 'Favorite card memory from your playing days?' },
        { type: 'question', text: 'Favorite card design, classic or modern?' },
        { type: 'question', text: 'If you could build a throwback insert, what is the name and vibe?' },
        { type: 'question', text: 'What made you a true 1/1 as a player?' },
        { type: 'question', text: 'What career moment deserves to live on a card forever?' },
        { type: 'question', text: 'What do you love about the hobby keeping eras alive across generations?' },
        { type: 'question', text: 'If a kid pulls your card today, what do you hope they feel?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ]
    }
  },
  {
    ...
    questions: {
      signing: [
        { type: 'checklist', text: 'Intro (no specifics needed).' },
        { type: 'question', text: 'What moment from this season would you want captured on a card forever?' },
        { type: 'question', text: 'What do you want your signature style as a QB to be known for?' },
        { type: 'question', text: 'What does it mean seeing your story collected in real time?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ],
      packRip: [
        { type: 'checklist', text: 'Intro (no specifics needed).' },
        ...
        { type: 'question', text: 'Favorite card memory growing up?' },
        { type: 'question', text: 'Favorite card design you have seen lately?' },
        { type: 'question', text: 'If you could design a ‘big-throw’ insert, what is the theme and name?' },
        { type: 'question', text: 'What makes you a true 1/1?' },
        { type: 'question', text: 'What moment from your journey deserves to live on a card forever?' },
        { type: 'question', text: 'What part of your game feels most unique right now?' },
        { type: 'question', text: 'If a kid pulls your card today, what do you hope they feel?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ]
    }
  ...
  // =====================
  {
    ...
    questions: {
      signing: [
        ...
        { type: 'question', text: 'What is the moment from this season you would want captured on a card forever?' },
        { type: 'question', text: 'At QB, leadership is the job. What standard do you try to set every week?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ],
      packRip: [
        { type: 'checklist', text: 'Intro (no specifics needed).' },
        ...
        { type: 'question', text: 'Favorite card memory growing up?' },
        { type: 'question', text: 'Favorite card design you have seen, and why it stood out?' },
        { type: 'question', text: 'If you could design a QB insert, what is the concept?' },
        { type: 'question', text: 'What makes you a true 1/1?' },
        { type: 'question', text: 'What career moment deserves to live on a card forever?' },
        { type: 'question', text: 'What does it mean knowing kids are collecting you while watching you lead a franchise?' },
        { type: 'question', text: 'If a kid pulls your card today, what do you hope they feel?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ]
    }
  },
  {
    ...
    questions: {
      signing: [
        ...
        {
          type: 'question',
          text: 'If you sign anything today, what do you want collectors to feel when they see your autograph on a new release?'
        },
        { type: 'question', text: 'What is the moment from your journey that deserves to live on a card forever?' },
        { type: 'question', text: 'What makes you a true 1/1 as you build your NFL story?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ],
      packRip: [
        { type: 'checklist', text: 'Intro (no specifics needed).' },
        ...
        { type: 'question', text: 'Favorite card memory growing up?' },
        { type: 'question', text: 'Favorite card design you have seen lately?' },
        { type: 'question', text: 'If you could design a Saints-themed insert, what is the name and vibe?' },
        { type: 'question', text: 'What makes you a true 1/1?' },
        { type: 'question', text: 'What moment from your journey deserves to live on a card forever?' },
        { type: 'question', text: 'What has been the biggest growth moment for you as you stepped into the league?' },
        { type: 'question', text: 'If a kid pulls your card today, what do you hope they feel?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ]
    }
  },
  {
    ...
    questions: {
      signing: [
        ...
        { type: 'question', text: 'What is the moment from this season you would want captured on a card forever?' },
        { type: 'question', text: 'Your game is detail and timing. What part of your craft do you take the most pride in?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ],
      packRip: [
        { type: 'checklist', text: 'Intro (no specifics needed).' },
        ...
        { type: 'question', text: 'Favorite card memory growing up?' },
        { type: 'question', text: 'Favorite card design you have seen lately?' },
        { type: 'question', text: 'If you could design a ‘highlight catch’ insert, what is the concept and name?' },
        { type: 'question', text: 'What makes you a true 1/1?' },
        { type: 'question', text: 'What career moment deserves to live on a card forever?' },
        { type: 'question', text: 'What does being part of the Panini family mean to you?' },
        { type: 'question', text: 'If a kid pulls your card today, what do you hope they feel?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ]
    }
  },
  {
    ...
    questions: {
      packRip: [
        { type: 'checklist', text: 'Intro (no specifics needed).' },
        { type: 'question', text: 'Who are you hoping to pull right now?' },
        { type: 'question', text: 'Favorite card memory from your era?' },
        { type: 'question', text: 'Favorite card design, classic or modern?' },
        { type: 'question', text: 'If you could design a lockdown-corner insert, what is the concept and name?' },
        { type: 'question', text: 'What made you a true 1/1 at corner?' },
        { type: 'question', text: 'What career moment deserves to live on a card forever?' },
        { type: 'question', text: 'What do you love about seeing defenders celebrated in the hobby?' },
        { type: 'question', text: 'If a kid pulls your card today, what do you hope they feel?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ]
    }
  },
  {
    ...
    questions: {
      packRip: [
        { type: 'checklist', text: 'Intro (no specifics needed).' },
        { type: 'question', text: 'Who are you hoping to pull right now?' },
        { type: 'question', text: 'Favorite card memory from the dynasty era?' },
        { type: 'question', text: 'Favorite card design, classic or modern?' },
        { type: 'question', text: 'If you could design a Patriots-dynasty insert, what is the name and vibe?' },
        { type: 'question', text: 'What made you a true 1/1 in big games?' },
        { type: 'question', text: 'What career moment deserves to live on a card forever?' },
        { type: 'question', text: 'What do you love about collectors keeping those eras alive?' },
        { type: 'question', text: 'If a kid pulls your card today, what do you hope they feel?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ]
    }
  },
  {
    ...
    questions: {
      packRip: [
        ...
        { type: 'question', text: 'Favorite card memory growing up?' },
        { type: 'question', text: 'Favorite card design you have seen lately?' },
        { type: 'question', text: 'If you could design a defense-first insert, what is the concept and name?' },
        { type: 'question', text: 'What makes you a true 1/1?' },
        { type: 'question', text: 'What career moment deserves to live on a card forever?' },
        { type: 'question', text: 'What do you take the most pride in as a pass rusher?' },
        { type: 'question', text: 'If a kid pulls your card today, what do you hope they feel?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ]
    }
  },
  {
    ...
    questions: {
      packRip: [
        ...
        { type: 'question', text: 'Favorite card memory from your era?' },
        { type: 'question', text: 'Favorite card design, classic or modern?' },
        { type: 'question', text: 'If you could design a Texas-legend insert, what would it look like?' },
        { type: 'question', text: 'What made you a true 1/1 as a player?' },
        { type: 'question', text: 'What career moment deserves to live on a card forever?' },
        { type: 'question', text: 'What does the Panini family mean to you?' },
        { type: 'question', text: 'If a kid pulls your card today, what do you hope they feel?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ]
    }
  },
  {
    ...
    questions: {
      signing: [
        ...
        { type: 'question', text: 'What moment from this season would you want captured on a card forever?' },
        { type: 'question', text: 'You and Panini go way back. What does the Panini family mean to you?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ],
      packRip: [
        { type: 'checklist', text: 'Intro (no specifics needed).' },
        ...
        { type: 'question', text: 'Favorite card memory growing up?' },
        { type: 'question', text: 'Favorite card design you have seen lately?' },
        { type: 'question', text: 'If you could design a defense-first insert, what is the theme and name?' },
        { type: 'question', text: 'What makes you a true 1/1?' },
        { type: 'question', text: 'What career moment deserves to live on a card forever?' },
        { type: 'question', text: 'What does being part of the Panini family mean to you?' },
        { type: 'question', text: 'If a kid pulls your card today, what do you hope they feel?' },
  ...
  },
  {
    ...
    questions: {
      signing: [
        { type: 'checklist', text: 'Intro (no specifics needed).' },
        { type: 'question', text: 'For a Hall of Fame career, what is the moment you would want on a card forever?' },
        { type: 'question', text: 'Your game was toughness and YAC. What did you take the most pride in?' },
        { type: 'question', text: 'What does being part of the Panini family mean to you today?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ],
      packRip: [
        { type: 'checklist', text: 'Intro (no specifics needed).' },
        ...
        { type: 'question', text: 'Favorite card memory from your playing days?' },
        { type: 'question', text: 'Favorite card design, classic or modern?' },
        { type: 'question', text: 'If you could design a throwback Bills-era insert, what is the theme and name?' },
        { type: 'question', text: 'What made you a true 1/1?' },
        { type: 'question', text: 'What career moment deserves to live on a card forever?' },
        { type: 'question', text: 'What does being part of the Panini family mean to you?' },
        { type: 'question', text: 'If a kid pulls your card today, what do you hope they feel?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
  ...
  },
  {
    ...
    questions: {
      signing: [
        ...
        { type: 'question', text: 'What is the moment from this season you would want captured on a card forever?' },
        { type: 'question', text: 'What part of your game has taken the biggest step forward this year?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ],
      packRip: [
        { type: 'checklist', text: 'Intro (no specifics needed).' },
        ...
        { type: 'question', text: 'Favorite card memory growing up?' },
        { type: 'question', text: 'Favorite card design you have seen lately?' },
        { type: 'question', text: 'If you could design a ‘future stars’ insert, what is the theme and name?' },
        { type: 'question', text: 'What makes you a true 1/1?' },
        { type: 'question', text: 'What moment from your journey deserves to live on a card forever?' },
        { type: 'question', text: 'What is your favorite part of playing on the Oregon stage?' },
        { type: 'question', text: 'If a kid pulls your card today, what do you hope they feel?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ]
    }
  ...
  // =====================
  {
    ...
    questions: {
      signing: [
        ...
        {
          type: 'question',
          text: 'If you have time to sign stickers today, what do you want a young collector to feel when they get it?'
        },
        { type: 'question', text: 'What moment from your season would you want captured on a card forever?' },
        { type: 'question', text: 'What makes you a true 1/1 as you start this next chapter?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ],
      packRip: [
        { type: 'checklist', text: 'Intro (no specifics needed).' },
        ...
        { type: 'question', text: 'What makes you a true 1/1?' },
        { type: 'question', text: 'What moment from your journey deserves to live on a card forever?' },
        { type: 'question', text: 'What is the biggest goal you are chasing next?' },
        { type: 'question', text: 'If a kid pulls your card today, what do you hope they feel?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ]
    }
  },
  {
    ...
    questions: {
      packRip: [
        ...
        { type: 'question', text: 'Favorite card memory from your playing days?' },
        { type: 'question', text: 'Favorite card design, classic or modern?' },
        { type: 'question', text: 'If you could design a ‘playoff legend’ insert, what is the name and vibe?' },
        { type: 'question', text: 'What made you a true 1/1 in big moments?' },
        { type: 'question', text: 'What career moment deserves to live on a card forever?' },
        { type: 'question', text: 'What do you love about fans keeping those moments alive through collecting?' },
        { type: 'question', text: 'If a kid pulls your card today, what do you hope they feel?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ]
    }
  ...
  // =====================
  {
    ...
    questions: {
      signing: [
        { type: 'checklist', text: 'Intro (no specifics needed).' },
        { type: 'question', text: 'For a career full of big moments, what is the signature moment you would want on a card forever?' },
        { type: 'question', text: 'Your game is detail. What part of the craft are you proudest of?' },
        { type: 'question', text: 'What does it mean signing a new release knowing collectors will keep these for years?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ]
    }
  },
  {
    ...
    questions: {
      signing: [
        ...
        {
          type: 'question',
          text: 'Your versatility stands out. What role do you love most: running, receiving, or return-game impact?'
        },
        { type: 'question', text: 'What moment from this season would you want captured on a card forever?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ]
  ...
  },
  {
    ...
    questions: {
      signing: [
        ...
        { type: 'question', text: 'Your game is about finishing. What is the mindset when it is time to close a drive?' },
        { type: 'question', text: 'What moment from this season would you want captured on a card forever?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ]
    }
  },
  {
    ...
    questions: {
      signing: [
        ...
        { type: 'question', text: 'Tight end is about trust. What do you want your QB to know he is getting from you every snap?' },
        { type: 'question', text: 'What moment from this season would you want captured on a card forever?' },
        { type: 'checklist', text: 'Outro (no specifics needed).' }
      ]
    }
